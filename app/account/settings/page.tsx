...
export const metadata: Metadata = {
  title: "Account Settings | Veliano Jewelry",
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Get notifications about your order status</p>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Receive confirmation when an order is placed</p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <Separator />
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Notifications for price drops on wishlist items</p>
                  </div>
                  <Switch />
                </div>
                <Separator />
